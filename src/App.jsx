...
const PAINTINGS_DATA = [
  ...
  { id: 7, title: "THE STARRY NIGHT", year: 1889, artist: "VINCENT VAN GOGH", museum: "MUSEUM OF MODERN ART", img: "./src/assets/img/The-Starry-Night-1200x630-1-979x514.jpg.webp" },
  ...
  { id: 9, title: "THE SCREAM", year: 1893, artist: "EDVARD MUNCH", museum: "NATIONAL GALLERY", img: "./src/assets/img/1920px-The_Scream.jpg" },
  { id: 10, title: "GUERNICA", year: 1937, artist: "PABLO PICASSO", museum: "MUSEUM OF MODERN ART", img: "./src/assets/img/71Ion8xjswL._AC_UF1000,1000_QL80_.jpg" },
  { id: 11, title: "THE KISS", year: 1907, artist: "GUSTAV KLIMT", museum: "BELVEDERE MUSEUM", img: "./src/assets/img/KL1267-1000x1000.jpg" },
  ...
  { id: 13, title: "GIRL WITH A PEARL EARRING", year: 1665, artist: "JOHANNES VERMEER", museum: "MAURITSHUIS", img: "./src/assets/img/images.jpg" },
  ...
  { id: 16, title: "WANDERER ABOVE THE SEA OF FOG", year: 1818, artist: "CASPAR DAVID FRIEDRICH", museum: "KUNSTHALLE HAMBURG", img: "./src/assets/img/wandrear.jpg" },
  { id: 17, title: "IMPRESSION, SUNRISE", year: 1872, artist: "CLAUDE MONET", museum: "MUSEЕ MARMOTTAN MONET", img: "./src/assets/img/Monet_-_Impression,_Sunrise.jpg" },
  { id: 18, title: "THE PERSISTENCE OF MEMORY", year: 1931, artist: "SALVADOR DALI", museum: "MUSEUM OF MODERN ART", img: "./src/assets/img/The-Persistence-of-Memory-canvas-collection-Salvador-1931.webp" },
  { id: 19, title: "SPRINGTIME", year: 1873, artist: "PIERRE-AUGUSTE COT", museum: "METROPOLITAN MUSEUM", img: "./src/assets/img/PIERRE-AUGUSTE_COT_-_Primavera_(Museo_Metropolitano_de_Nueva_York,_1873._Óleo_sobre_lienzo,_213.4_x_127_cm).jpg" },
  { id: 20, title: "THE STORM ON THE SEA OF GALILEE", year: 1633, artist: "REMBRANDT", museum: "BOSTON MUSEUM", img: "./src/assets/img/Rembrandt_Christ_in_the_Storm_on_the_Lake_of_Galilee.jpg" }
];
